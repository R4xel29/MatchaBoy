...
export const PRODUCTS: Product[] = [
    {
        ...
        price: 35000,
        image: '/products/matcha-signature.jpg',
        category: 'signature',
        badge: 'best-seller',
        modifiers: {
    ...
    },
    {
        ...
        price: 38000,
        image: '/products/dirty-matcha.jpg',
        category: 'signature',
        badge: 'new',
        modifiers: {
            iceLevel: ['Normal Ice', 'Less Ice', 'No Ice'],
    ...
    },
    {
        ...
        price: 42000,
        image: '/products/matcha-biscoff.jpg',
    ...
    },
    {
        ...
        price: 36000,
        image: '/products/matcha-strawberry.jpg',
        category: 'seasonal',
        badge: 'new',
        modifiers: {
            iceLevel: ['Normal Ice', 'Less Ice', 'No Ice'],
    ...
    },
    {
        ...
        price: 45000,
        image: '/products/matcha-affogato.jpg',
        category: 'hidden-menu',
        modifiers: {
            addOns: ADD_ONS,
        },
    },
    {
        ...
        price: 25000,
        image: '/products/matcha-croissant.jpg',
        category: 'pastries',
        badge: 'new',
    },
    {
        ...
        price: 18000,
        image: '/products/matcha-cookie.jpg',
        category: 'pastries',
        badge: 'best-seller',
    },
    {
        ...
        price: 35000,
        image: '/products/matcha-tiramisu.jpg',
        category: 'pastries',
    },
    {
        id: 'yuzu-matcha',
        ...
        price: 38000,
        image: '/products/yuzu-matcha.jpg',
        category: 'seasonal',
        badge: 'new',
    },
    {
        ...
        price: 40000,
        image: '/products/matcha-mochi.jpg',
        category: 'hidden-menu',
        badge: 'sold-out',
        modifiers: {
            iceLevel: ['Normal Ice', 'Less Ice', 'No Ice'],
