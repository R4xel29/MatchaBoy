  ...
  return (
    <div className="min-h-dvh bg-background flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="relative mb-6">
        <div className="w-28 h-28 rounded-3xl bg-gradient-to-br from-brand-100 to-brand-200 
          flex items-center justify-center shadow-lg shadow-brand-200/30 rotate-6">
      ...
      <Link
        href="/"
        className="px-8 py-3.5 rounded-xl gradient-brand text-white 
          font-semibold text-sm shadow-lg shadow-brand-700/20
