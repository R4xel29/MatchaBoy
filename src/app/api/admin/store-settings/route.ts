    ...
    if (existing) {
      const updated = await prisma.storeSettings.update({
        ...
        data: {
          ...
          alarmSoundUrl: body.alarmSoundUrl !== undefined ? body.alarmSoundUrl : existing.alarmSoundUrl,
          alarmVolumeBoost: body.alarmVolumeBoost !== undefined ? Number(body.alarmVolumeBoost) : existing.alarmVolumeBoost,
      ...
      const created = await prisma.storeSettings.create({
        data: {
          ...
          whatsappMessage: body.whatsappMessage || 'Halo Arum Seduh, saya ingin bertanya...',
          pickupAlarmLeadTime: body.pickupAlarmLeadTime !== undefined ? Number(body.pickupAlarmLeadTime) : 30,
          alarmSoundUrl: body.alarmSoundUrl || '',
          alarmVolumeBoost: body.alarmVolumeBoost !== undefined ? Number(body.alarmVolumeBoost) : 350,
